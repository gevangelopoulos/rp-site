...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Got a question about one of our services? Want to get in touch? Let us know.</p>
      <form name="contact" action="https://formsubmit.co/984d49d8be75da51d6d8092e0b101423" method="POST" class="space-y-8">
          <div class="my-4">
